...
export default function AdminCoursesPage() {
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      ...
      {/* Course info card */}
      <Card className="p-5 mb-6 bg-gradient-to-r from-[#1B4332]/5 to-[#B8860B]/5 border-primary/20">
      ...
      <div className="space-y-2">
        {loading
          ...
          : lessons.map((lesson) => (
            ...
            >
              {/* Number */}
              <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-[#1B4332]/20 to-[#B8860B]/20 border border-primary/20 flex items-center justify-center text-sm font-bold text-primary shrink-0">
                {lesson.topicNumber}
              </div>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-surface-2 border border-border rounded-xl text-sm text-text-primary placeholder-text-muted focus:outline-none focus:border-primary/50 transition-colors"
              />
            </div>
            <div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-surface-2 border border-border rounded-xl text-sm text-text-primary placeholder-text-muted focus:outline-none focus:border-primary/50 transition-colors font-mono"
            />
          </div>
